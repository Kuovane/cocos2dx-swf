...
#include <assert.h>
#include "image.h"	// for delete m_suspended_image
#include "container.h"	// for hash<...>
#include "tu_gc.h"
...
//		create_font_shapes_flag cfs);
	...
	struct rect
	{
		...
		point getAnchorPoint() {
			return point(-this->m_x_min / width(), m_y_max / height());
		}
	...
	struct render_handler
	{
		...
		virtual void setGenImageMode(bool bGenImageMode) = 0;
